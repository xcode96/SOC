{
  "homeCards": [
    ...
    },
    {
      ...
      "tag": {
        "name": "Scripting",
        "color": "bg-blue-500/50 text-white"
      },
      "status": "Explore the guide",
    ...
    },
    {
      ...
      "tag": {
        "name": "Python",
        "color": "bg-emerald-600/50 text-white"
      },
      "status": "Coming Soon",
      "href": "#"
    },
    ...
    },
    {
      ...
      "tag": {
        "name": "Dart",
        "color": "bg-sky-500/50 text-white"
      },
      "status": "Coming Soon",
      "href": "#"
    },
  ...
  "guideData": {
    ...
    "powershell": {
      "title": "PowerShell Interactive Guide",
      "topics": [
        {
          "id": "ps-introduction",
          ...
          "content": [
            ...
            {
              "type": "p",
              "text": "Built on the .NET Framework, PowerShell helps IT professionals and power users control and automate the administration of the Windows operating system and applications that run on Windows."
            },
            {
              "type": "highlight",
              "color": "green",
              "text": "PowerShell is now open-source and available on Windows, macOS, and Linux."
            }
          ]
        },
        {
        ...
        },
        {
          ...
          "content": [
            ...
            {
              "type": "p",
              "text": "Content for this topic is coming soon."
            }
          ]
        }
      ]
      ...
      "topics": [
        {
          ...
          "content": [
            {
              "type": "h2",
              "text": "Welcome to the love Guide"
            },
            {
              "type": "p",
              "text": "This is a new guide. Start adding topics!"
            }
          ]
        }
      ]
    ...
    "testing": {
      "title": "testing Interactive Guide",
      "topics": [
        {
          "id": "toc",
          ...
          "content": [
            {
              "type": "h2",
              "text": "Welcome to the testing Guide"
            },
            {
              "type": "p",
              "text": "This is a new guide. Start adding topics!"
